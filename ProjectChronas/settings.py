...
ZIINA_WEBHOOK_SECRET = os.getenv("ZIINA_WEBHOOK_SECRET")
...
DHL_BASE_URL = env("DHL_BASE_URL")

DHL_SHIPPER_NAME = env("DHL_SHIPPER_NAME")
DHL_SHIPPER_PHONE = env("DHL_SHIPPER_PHONE")
DHL_SHIPPER_ADDRESS = env("DHL_SHIPPER_ADDRESS")
DHL_SHIPPER_CITY = env("DHL_SHIPPER_CITY")
DHL_SHIPPER_COUNTRY = env("DHL_SHIPPER_COUNTRY")
DHL_SHIPPER_POSTAL_CODE = env("DHL_SHIPPER_POSTAL_CODE")